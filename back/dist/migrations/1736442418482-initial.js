...
exports.Initial1736442418482 = void 0;
class Initial1736442418482 {
    constructor() {
        this.name = 'Initial1736442418482';
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`users\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(50) NOT NULL, \`email\` varchar(50) NOT NULL, \`password\` varchar(60) NOT NULL, \`phone\` int NULL, \`country\` varchar(50) NULL, \`address\` text NULL, \`city\` varchar(50) NOT NULL, \`isAdmin\` tinyint NOT NULL DEFAULT 1, UNIQUE INDEX \`IDX_97672ac88f789774dd47f7c8be\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`order_entity\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), \`userId\` varchar(36) NULL, \`orderDetailsId\` int NULL, UNIQUE INDEX \`REL_31c634dc296fbdd97533ca8ec4\` (\`orderDetailsId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
...
exports.Initial1736442418482 = Initial1736442418482;
//# sourceMappingURL=1736442418482-initial.js.map