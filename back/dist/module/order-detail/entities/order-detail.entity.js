...
__decorate([
    ...
    __metadata("design:type", Number)
], OrderDetailEntity.prototype, "totalPrice", void 0);
__decorate([
    (0, typeorm_1.OneToOne)(() => order_entity_1.OrderEntity, (o) => o.orderDetails, {
        onDelete: 'CASCADE',
        nullable: false
    }),
...
__decorate([
    (0, typeorm_1.ManyToMany)(() => product_entity_1.ProductEntity, (p) => p.orderDetails, {
        eager: true,
        cascade: true,
    }),
